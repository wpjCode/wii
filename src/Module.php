...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'wpjCode\wii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'wpjCode\wii\console\GenerateController',
    ...
    public function beforeAction($action)
    {
        ...
        // 内部可以 别名
        Yii::$aliases = array_merge(Yii::$aliases, [
            '@wpjCode' => [
                '@wpjCode/wii' => __DIR__
            ]
        ]);
        ...
        // i18n语言是否开启
        define('openI18n', true);
        // i18n语言文件分类
        define('I18nCategory', 'app');
        // i18n语言文件分类
        define('I18nPath', '@wpjCode/wii/messages');
        // y语言包文件 - 中文
        Yii::$app->language = 'zh-CN';
        // i18n语言文件赋值默认的路径
        Yii::$app->i18n->translations[I18nCategory]['basePath'] = I18nPath;
    ...
    {
        return [
            'model' => ['class' => 'wpjCode\wii\generators\model\Generator'],
            'doModel' => ['class' => 'wpjCode\wii\generators\doModel\Generator'],
            'crud' => ['class' => 'wpjCode\wii\generators\crud\Generator'],
//            'form' => ['class' => 'wpjCode\wii\generators\form\Generator'],
//            'module' => ['class' => 'wpjCode\wii\generators\module\Generator'],
//            'extension' => ['class' => 'wpjCode\wii\generators\extension\Generator'],
        ];
    }
