...
use wpjCode\wii\components\ActiveField;
use wpjCode\wii\CodeFile;

/* @var $this yii\web\View */
/* @var $generator wpjCode\wii\Generator */
...
<div class="default-view">
    <h1><?= Html::encode($generator->langString($this->title)) ?></h1>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10" id="form-fields">
                ...
                <?= $form->field($generator, 'template')
                    ->sticky()
                    ->hint($generator->langString('Code Template Hint'))
                    ->label($generator->langString('Code Template'))
