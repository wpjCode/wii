...
namespace wpjCode\wii\generators\model;
...
//    public $cacheBaseClass = 'app\models\cache\CacheBase';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['enableI18N', 'standardizeCapitals', 'isCacheModel'], 'boolean'],
    ...
    public function generate()
    {
        ...
        // 判断是否走缓存模板
        $templateFile = 'model.php';
        if ($this->isCacheModel) $templateFile = 'cacheModel.php';

//        // 验证基础类文件是否存在
//        $value = ltrim($this->cacheBaseClass, '\\');
//        $path = Yii::getAlias('@' . str_replace('\\', '/', $value), false);
//        $path = $path . '.php';
//        if ($this->cacheModel && (!file_exists($path) || !class_exists($this->cacheBaseClass))) {
//            $files[] = new CodeFile($path, $this->render('cacheBase.php', []));
//        }
