 ...
 * @property string $modelClass custom code model.Extend from $baseModelClass class
...
class Generator extends \wpjCode\wii\Generator
{
    ...
    {
        return $this->langString('CRUD Generator');
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['controllerDoClass', 'controllerShowClass', 'baseModelClass', 'modelClass', 'baseControllerClass', 'expName', 'controllerShowLayout', 'viewPath', 'jsPath', 'cssPath'], 'filter', 'filter' => 'trim'],
            [['modelClass', 'baseModelClass', 'controllerDoClass', 'controllerShowClass', 'baseControllerClass', 'expName', 'viewPath', 'controllerShowLayout', 'jsPath', 'cssPath'], 'required'],
            [['modelClass', 'baseModelClass', 'controllerDoClass', 'controllerShowClass', 'baseControllerClass'], 'match', 'pattern' => '/^[\w\\\\]*$/', 'message' => $this->langString('just characters and backslashes')],
            ...
            [['baseModelClass'], 'validateModelClass']
        ]);
    }
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'modelClass' => $this->langString('Model Class'),
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'modelClass' => $this->langString('Model Class Hint'),
    ...
    {
        return ['model.php', 'doController.php', 'showController.php'];
    }
    ...
    public function validateModelClass()
    {
        ...
        $pk = $class::primaryKey();
        if (empty($pk)) {
            $this->addError('modelClass', $this->langString('modelClassErr_1'));
        }
    }
    ...
    public function generate()
    {
        ...
        $files = [];
        // ****** 1、基础类 ******
        $modelClass = Yii::getAlias('@' . str_replace('\\', '/', ltrim($this->modelClass, '\\')) . '.php');
        $files[] = new CodeFile($modelClass, $this->render('model.php'));
     ...
     */
    public function getControllerDoID()
    {
     ...
     */
    public function getControllerShowID()
    {
    ...
    public function getRenderViewPath($path)
    {
        ...
        // 页面展示控制器 文件夹
        $showConDir = pathinfo($showConPath)['dirname'];
        ...
        if (in_array($showConPath, $modulesConList) && $this->isControlViewPath($showConPath)) {
            return $path;
        }
    ...
    private function isControlViewPath($controlPath = '') {
        ...
        foreach (Yii::$app->modules as $k => $v) {
            ...
            if ($modulesConPath == $pathInfo['dirname'] && $this->viewPath == $modulesViewPath) {
