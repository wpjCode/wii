...
AppAsset::addCss(\$this, '{$generator->getPageCssPath('index')}');
?>
EOT;
?>
...
<div class="app-container" id="indexContainer" v-show="loadOver" style="display: none;">
    ...
    <div class="content-container">
        <el-scrollbar class="main-scroller" style="height: 100%">
            <div class="top-wrapper">
                ...
                <!-- 提醒 END -->
                <el-form v-on:keyup.native.enter="getList()" :inline="true"
                         :model="searchForm" class="search-form-inline">
                    <!-- 顶部操作按钮 START -->
                    <el-row :inline="true" class="do-top-wrapper">
                        <el-col :span="10">
                            <el-button class="" size="mini" type="success" @click.native="goToAdd()">
                                新建
                            </el-button>
                    ...
                    <!-- 底部搜索群 START -->
                    <el-row :inline="true" :gutter="0" class="search-top-wrapper">
                        <el-col :span="8">
                            <el-form-item>
                        ...
                        <el-col :span="4" class="text-right">
                            &nbsp;
                            <el-form-item label="" class="search-no-line-height" style="display: none;">
                                &nbsp;
                            </el-form-item>
                        </el-col>
                        <el-col :span="6" class="text-right">
                            <el-form-item label="" class="search-no-line-height txt-right">
                ...
                <el-table-column fixed="right" label="操作" width="180">
                    <template slot-scope="scope">
                        <el-button type="text" size="small"
                                   @click.native="goToEdit(scope.row.id)">编辑
                        </el-button>
...
<?= <<<EOT
<?= AppAsset::addScript(\$this, '{$generator->getPageJsPath('index')}'); ?>
<?= \$this->registerJs('
    new app();
'); ?>
EOT;
